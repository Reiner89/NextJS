...
export default function NotFoundPage() {
  return (
    <div className="h-full w-full overflow-hidden bg-[#0a0a0a] text-white antialiased selection:bg-sky-500 selection:text-white">
      <div className="flex h-full">
        <main className="relative flex h-screen flex-1 items-center justify-center overflow-y-auto">
